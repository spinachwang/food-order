...
AgentState = TypedDict(
    "AgentState",
    {
        ...
        # 8-char hex correlation ID, generated by the API entry
        # (`api/v1/agent.py`) and mirrored in `app.core.request_id`.
        # Nodes prefer `get_request_id()` from the contextvar; this
        # fallback covers cases where contextvar inheritance is broken.
        "request_id": str | None,
        # F002 router outputs.
